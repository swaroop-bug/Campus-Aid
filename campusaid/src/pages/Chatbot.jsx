...
export default function Chatbot() {
  ...
  const handleSend = async (e) => {
    ...
    try {
      ...
      const botReply = response.reply || "I'm sorry, I couldn't process that request.";
      setMessages(prev => [...prev, { role: 'bot', content: botReply }]);
    } catch (error) {
      setMessages(prev => [...prev, {
        role: 'bot',
        content: "I'm having trouble reaching my knowledge base. Please try again!"
      }]);
    } finally {
      setIsLoading(false);
    }
    ...
    <div className="fade-in" style={{
      ...
      <div className="neo-container" style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          ...
          <div>
            <h2 className="neo-title" style={{ margin: 0, fontSize: '1.5rem' }}>
              CampusAid Assistant
            </h2>
            <div style={{
              display: 'flex', alignItems: 'center', gap: '0.5rem',
              fontSize: '0.85rem', color: 'var(--neo-success)'
            }}>
      ...
      <div className="neo-container" style={{ padding: '1rem', background: 'rgba(17, 24, 39, 0.4)' }}>
        ...
        <form onSubmit={handleSend} style={{ display: 'flex', gap: '1rem' }}>
          <div className="neo-inset" style={{
            ...
            padding: '0 1.5rem', borderRadius: '15px'
          }}>
            ...
            <input
              ...
              placeholder="Ask me anything: coding help, general knowledge, or college info..."
              style={{
                width: '100%',
                background: 'none',
                border: 'none',
      ...
      <div style={{
        ...
        <Info size={14} />
        CampusAid Assistant can help with academic queries, programming help, and college info.
      </div>
    </div>
  );
}
